...
export default function OrderDetailPage() {
  ...
  // Handle "new" route - redirect to orders page or show create form
  if (orderId === "new") {
    return (
      <DashboardLayout>
        <div className="text-center py-8">
          ...
          <p className="text-muted-foreground mb-4">
            This page is for viewing existing orders. To create a new order, please use the main orders page.
          </p>
